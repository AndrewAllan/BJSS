...
public class OrderHistory {
	...
	public void checkMessageIsInList(String dateTimeIn){
		int counter =1;
		for(WebElement element : messageList)
		{
			if(element.getText().equalsIgnoreCase(dateTimeIn))
			{		
				System.out.println(driver.findElement(By.xpath(".//*[@id='block-order-detail']/div[5]/table/tbody/tr["+counter+"]/td[2]")).getText());	
			}
			counter +=1;
		}
	}
